USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[RP_SP_Con_12_Prov_Monthly_Summary_Tracking]    Script Date: 2021-07-10 1:50:50 PM ******/
SET ANSI_NULLS ON
GO
...
Create PROCEDURE [dbo].[RP_SP_Con_12_Prov_Monthly_Summary_Tracking]  --'01 Jan 2009', '31 oct 2009'
...
'FROM  dbo.Contract_Revenue_Prov_Tracking_sum_vw
