USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[LoadingBCDMatrixRateMissing2]    Script Date: 2021-07-10 1:50:49 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE  [dbo].[LoadingBCDMatrixRateMissing2]
AS
...
SELECT BCD# from dbo.BCDMatrix  where BCD#  in
(
'T355600 ',  
'A117100',   
'T576300' , 
