USE [GISData]
GO
/****** Object:  Table [dbo].[Damage_Incident]    Script Date: 2021-07-10 1:50:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Damage_Incident](
 ...
 CONSTRAINT [PK_Damage_Incident] PRIMARY KEY CLUSTERED 
(
	[Vehicle_Support_Incident_Seq] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 90) ON [PRIMARY]
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[Damage_Incident]  WITH NOCHECK ADD  CONSTRAINT [FK_Vehicle_Support_Incident07] FOREIGN KEY([Vehicle_Support_Incident_Seq])
REFERENCES [dbo].[Vehicle_Support_Incident] ([Vehicle_Support_Incident_Seq])
GO
ALTER TABLE [dbo].[Damage_Incident] CHECK CONSTRAINT [FK_Vehicle_Support_Incident07]
GO
