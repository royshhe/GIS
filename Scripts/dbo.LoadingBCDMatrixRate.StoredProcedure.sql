USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[LoadingBCDMatrixRate]    Script Date: 2021-07-10 1:50:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER OFF
GO

CREATE PROCEDURE  [dbo].[LoadingBCDMatrixRate]
AS
...
Update Organization Set Inactive =0 where BCD_Number in  (select dbo.BCDMatrix.BCD# from  dbo.BCDMatrix)
...
where BCD# not in (
						...
						FROM         dbo.BCDMatrix INNER JOIN
							  ...
							  dbo.BCDMatrix.KM_Cap = dbo.BCDMatrixBak.KM_Cap AND 
							  dbo.BCDMatrix.Class1 = dbo.BCDMatrixBak.Class1 AND 
...
BEGIN
				...
				SELECT  @CompanyName=CompanyName, 
								...
								@PerKmCharge1= (Case When KM_Cap<>'UNL'  then Mil1 
															Else 0
													 End) , 
								@PerKmCharge2= (Case When KM_Cap<>'UNL'  then Mil2 
															Else 0
													 End) , 
								@PerKmCharge3= (Case When KM_Cap<>'UNL'   then Mil3 
															Else 0
													 End) , 
								@PerKmCharge4= (Case When KM_Cap<>'UNL'  then Mil4 
															Else 0
													 End) , 
								@PerKmCharge5= (Case When KM_Cap<>'UNL'  then Mil5 
															Else 0
													 End) , 
								@PerKmCharge6= (Case When KM_Cap<>'UNL'  then Mil6 
															Else 0
													 End) , 
								@PerKmCharge7= (Case When KM_Cap<>'UNL'  then Mil7 
															Else 0
													 End) , 
								@PerKmCharge8= (Case When KM_Cap<>'UNL'  then Mil8 
															Else 0
													 End) ,
		...
		If @iCountBCD=0 
		exec CreateOrg @CompanyName, @BCDNumber, 'N/A', '', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', '', '', '', '', '', '', 'N', '', '', 'SQL Job', '1', '1', '0', '0', '', 'C'
		...
		BEGIN
               ...
               SELECT @Amount=(Case 
 				...
 				SELECT @PerKmCharge=(Case 
												When @VCCode='1' Then @PerKmCharge1
												When @VCCode='2' Then @PerKmCharge2
												When @VCCode='3' Then @PerKmCharge3
												When @VCCode='4' Then @PerKmCharge4
												When @VCCode='5' Then @PerKmCharge5
												When @VCCode='6' Then @PerKmCharge6
												When @VCCode='7' Then @PerKmCharge7
												When @VCCode='8' Then @PerKmCharge8
											End)
