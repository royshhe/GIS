USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[ITB_UpdateITBRBR]    Script Date: 2021-07-10 1:50:49 PM ******/
SET ANSI_NULLS OFF
GO
...
CREATE PROCEDURE [dbo].[ITB_UpdateITBRBR]
	@RBRDate varchar(24)
AS
	...
	UPDATE	rbr_date
	   SET	Date_ITB_Invoice_Generated = GETDATE()
