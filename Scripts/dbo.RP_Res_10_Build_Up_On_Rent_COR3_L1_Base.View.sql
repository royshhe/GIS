USE [GISData]
GO
/****** Object:  View [dbo].[RP_Res_10_Build_Up_On_Rent_COR3_L1_Base]    Script Date: 2021-07-10 1:50:45 PM ******/
SET ANSI_NULLS ON
GO
...
/*
VIEW NAME:  	RP_Res_10_Build_Up_On_Rent_COR3_L1_Base
...
USED BY: 	View RP_Res_10_Build_Up_On_Rent_COR3_L2_Base
MOD HISTORY:
Name 		Date		Comments
Joseph Tseung	2000/02/25	Exclude foreign contracts (contracts picked up at foreign locations)
				in the count
*/

CREATE VIEW [dbo].[RP_Res_10_Build_Up_On_Rent_COR3_L1_Base]
AS
SELECT  CONVERT(datetime, CONVERT(varchar(12), Contract.Pick_Up_On, 112)) AS Cont_PU_Date, 
	CONVERT(datetime, CONVERT(varchar(12), Contract.Drop_Off_On, 112)) AS Cont_DO_Date, 
