USE [GISData]
GO
/****** Object:  View [dbo].[RP_Acc_17_CSR_Incremental_Yield_L1]    Script Date: 2021-07-10 1:50:44 PM ******/
SET ANSI_NULLS ON
GO
...
--
------------------------------------------------------------------------------------------------------------------------
CREATE View [dbo].[RP_Acc_17_CSR_Incremental_Yield_L1]
as
Select 	
	bt.RBR_Date, 
    	bt.Contract_Number, 
...
WHERE 	
	...
	or (bt.Contract_number IN (2334110,2334997,2334624,2335216,2335416,2336634,2336984,2337324,2337319,2337268,2336961,2337919,2337309,2336813,2335544,2338471,2336877,2338721,2340252,2339435,2343496))
