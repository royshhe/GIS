USE [GISData]
GO
/****** Object:  View [dbo].[RP_Acc_24_CSR_SalesAcc_Revenue]    Script Date: 2021-07-10 1:50:46 PM ******/
SET ANSI_NULLS ON
GO
...
Name 		Date		Comments
*/
CREATE VIEW [dbo].[RP_Acc_24_CSR_SalesAcc_Revenue]
AS
...
FROM         dbo.Contract_Sales_Accessory INNER JOIN
					dbo.contract on dbo.contract.contract_number=dbo.Contract_Sales_Accessory.contract_number	INNER JOIN
                      ...
                      dbo.Contract_Payment_Item ON dbo.Contract_Sales_Accessory.Contract_Number = dbo.Contract_Payment_Item.Contract_Number  
													and dbo.Contract_Payment_Item.Sequence=0 INNER JOIN
                      --dbo.Sales_Accessory_Price ON dbo.Sales_Accessory.Sales_Accessory_ID = dbo.Sales_Accessory_Price.Sales_Accessory_ID INNER JOIN
