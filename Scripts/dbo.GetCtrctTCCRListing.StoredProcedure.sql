USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[GetCtrctTCCRListing]    Script Date: 2021-07-10 1:50:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE Procedure [dbo].[GetCtrctTCCRListing]
As 
Select 
...
on ConTCTotal.Contract_number=cci.Contract_Number and ConTCTotal.Issuer=cci.Issuer
 ...
 -- Turn on  alternative billing 2013-02-27
--Where  
...
--)
 ...
 order by ConTCTotal.Contract_Number
 
 
 --select * from Credit_card_Type
