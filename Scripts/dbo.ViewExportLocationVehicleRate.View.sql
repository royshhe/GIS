USE [GISData]
GO
/****** Object:  View [dbo].[ViewExportLocationVehicleRate]    Script Date: 2021-07-10 1:50:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [dbo].[ViewExportLocationVehicleRate]
AS
...
WHERE     (dbo.Location.Owning_Company_ID = 7425) AND (dbo.Location.Location IN ('B-01 YVR Airport', 'B-03 Downtown', 'B-04 Burrard')) AND 
