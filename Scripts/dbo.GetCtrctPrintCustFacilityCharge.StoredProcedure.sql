USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[GetCtrctPrintCustFacilityCharge]    Script Date: 2021-07-10 1:50:48 PM ******/
SET ANSI_NULLS ON
GO
...
/*  PURPOSE:		To retrieve the location fee for the given contract number..
     ...
     Name    Date        Comments
*/
CREATE PROCEDURE [dbo].[GetCtrctPrintCustFacilityCharge] --'900957'
	@CtrctNum Varchar(10)
AS
