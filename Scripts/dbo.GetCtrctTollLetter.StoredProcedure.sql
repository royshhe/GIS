USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[GetCtrctTollLetter]    Script Date: 2021-07-10 1:50:48 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[GetCtrctTollLetter]  -- 1628745, '11 Mar 2013', 'T2'
(
...
Where     dbo.Bridge_Toll_vw.Status='CI'
		...
		And Bridge_Toll_vw.Contract_Number=Convert(int, @ContractNumber)
		And Bridge_Toll_vw.RBR_Date= @dtRBRDate
		And dbo.Bridge_Toll_vw.IssuerCode=@Issuer
