USE [GISData]
GO
/****** Object:  View [dbo].[Contract_Revenue_Prov_Tracking_sum_vw]    Script Date: 2021-07-10 1:50:45 PM ******/
SET ANSI_NULLS ON
GO
...
----------------------------------------------------------------------------------------------------------------------*/
create VIEW [dbo].[Contract_Revenue_Prov_Tracking_sum_vw]
AS
...
FROM         dbo.Contract_Revenue_Prov_Tracking_Detail_vw
