USE [GISData]
GO
/****** Object:  View [dbo].[RT_Contract_Sub_Vehicle_BaseRate_Amount]    Script Date: 2021-07-10 1:50:46 PM ******/
SET ANSI_NULLS ON
GO
...
/*
VIEW NAME: RT_Contract_Sub_Vehicle_BaseRate_Amount
...
*/
CREATE View [dbo].[RT_Contract_Sub_Vehicle_BaseRate_Amount]
as
...
FROM         dbo.Contract INNER JOIN
	...
	dbo.RP__Last_Vehicle_On_Contract.Actual_Vehicle_Class_Code = dbo.RT_LocationVehicleRateAmount.Vehicle_Class_Code AND 
