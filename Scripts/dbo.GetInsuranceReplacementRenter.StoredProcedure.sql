USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[GetInsuranceReplacementRenter]    Script Date: 2021-07-10 1:50:48 PM ******/
SET ANSI_NULLS OFF
GO
...
*/
CREATE PROCEDURE [dbo].[GetInsuranceReplacementRenter]
	@CtrctNum	varchar(11)
AS
...
DECLARE	@iCtrctNum Int
	...
	SELECT	Vehicle_Licence_Plate,
			...
			Last_Change_By,
			Last_Change_On
	  FROM	Insurance_Replacement_Renter
