USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[RP_SP_Con_12_Fed_Monthly_detail_Tracking]    Script Date: 2021-07-10 1:50:50 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[RP_SP_Con_12_Fed_Monthly_detail_Tracking] --'01 aug 2009', '31 jul 2010'
...
FROM Contract_Revenue_Fed_Tracking_sum_vw con left outer join reservation  res
