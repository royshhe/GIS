USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[RP_SP_Flt_17_Revenue_By_Vehicle_Unit]    Script Date: 2021-07-10 1:50:50 PM ******/
SET ANSI_NULLS ON
GO
...
Create PROCEDURE [dbo].[RP_SP_Flt_17_Revenue_By_Vehicle_Unit]  --'*','*', '01 Aug 2015', '30 Apr 2016'
(
...
-- new REvenue
	(SELECT 
		...
		model_name, 
		model_year, 
		sum(DaysCounter) as DaysCounter,
	...
	FROM  
	 (
			...
			DisplayOrder
--select *
		FROM      RP_FLT_17_Vehicle_Revenue_Main
	 ...
	 Group by  Vehicle_Type_ID, unit_number,  model_name,model_year 
 ) Revenue
