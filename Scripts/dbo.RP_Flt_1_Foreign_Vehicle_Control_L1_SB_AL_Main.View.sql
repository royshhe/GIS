USE [GISData]
GO
/****** Object:  View [dbo].[RP_Flt_1_Foreign_Vehicle_Control_L1_SB_AL_Main]    Script Date: 2021-07-10 1:50:46 PM ******/
SET ANSI_NULLS ON
GO
...
/*
VIEW NAME: RP_Flt_1_Foreign_Vehicle_Control_L1_SB_AL_Main
PURPOSE: Get the information about vehicles

AUTHOR:	Nenad Ukropina
DATE CREATED: 1999/01/01
USED BY: Subreport in the Foreign Vehicle Control (by Available Location) Report
    	 to create tabel with the location totals at the end of report
MOD HISTORY:
Name 		Date		Comments
Joseph Tseung	2000/01/21	Exclude deleted vehicles
*/
CREATE VIEW [dbo].[RP_Flt_1_Foreign_Vehicle_Control_L1_SB_AL_Main]
AS
SELECT Vehicle.Unit_Number, 
	...
	Vehicle.Current_Rental_Status, 
    	...
    	Location.Location Available_Location_Name, 
    	Vehicle_Class.Vehicle_Type_ID, 
    	Vehicle.Current_Location_ID Available_Location_ID
...
WHERE 	(Vehicle.Current_Rental_Status = 'b') AND 
