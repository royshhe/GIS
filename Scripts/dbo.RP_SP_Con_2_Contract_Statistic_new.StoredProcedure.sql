USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[RP_SP_Con_2_Contract_Statistic_new]    Script Date: 2021-07-10 1:50:50 PM ******/
SET ANSI_NULLS ON
GO
...
*/
/* updated to ver 80 */
create PROCEDURE [dbo].[RP_SP_Con_2_Contract_Statistic_new] --'01 jun 2011','30 jun 2011','Car','16'
(
...
-- less any discounts
	(SELECT 	
		cci.Contract_Number, 
		SUM( CASE 	WHEN Contract_Charge_Item.Charge_Type IN (10, 20,50, 51, 52)
		...
		SUM( CASE 	WHEN Contract_Charge_Item.Charge_Type IN (51,52)
					THEN Contract_Charge_Item.Amount
							-Contract_Charge_Item.GST_Amount_Included
							-Contract_Charge_Item.PST_Amount_Included
							-Contract_Charge_Item.PVRT_Amount_Included
