USE [GISData]
GO
/****** Object:  View [dbo].[RP_Acc_7_CSR_Performance_Contract_Rates_L2_Base_2]    Script Date: 2021-07-10 1:50:45 PM ******/
SET ANSI_NULLS ON
GO
...
/*
VIEW NAME: RP_Acc_7_CSR_Performance_Contract_Rates_L2_Base_2
PURPOSE: Get amounts for different time intervals for contract rate
	 		
AUTHOR:	Nenad Ukropina
DATE CREATED: 1999/01/01
USED BY: Stored Procedure RP_SP_Acc_7_CSR_Performance_Report_Main 
	to populate RP_Acc_7_CSR_Performance_Contract_Rates table
MOD HISTORY:
Name 		Date		Comments
...
*/
CREATE VIEW [dbo].[RP_Acc_7_CSR_Performance_Contract_Rates_L2_Base_2]
AS
...
FROM RP_Acc_7_CSR_Performance_Contract_Rates_L1_Base_1 WITH(NOLOCK)
GROUP BY
	Contract_Number,
	Rate_Name
