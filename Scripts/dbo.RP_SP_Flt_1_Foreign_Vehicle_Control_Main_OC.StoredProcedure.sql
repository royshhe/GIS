USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[RP_SP_Flt_1_Foreign_Vehicle_Control_Main_OC]    Script Date: 2021-07-10 1:50:50 PM ******/
SET ANSI_NULLS ON
GO
...
/*
PROCEDURE NAME: RP_SP_Flt_1_Foreign_Vehicle_Control_Main_OC
...
USED BY: Main report of Foreign Vehicle Control (by Owning Company)
...
*/
CREATE PROCEDURE [dbo].[RP_SP_Flt_1_Foreign_Vehicle_Control_Main_OC]
(
...
WHERE 	(@paramOwningCompanyID = "*" or CONVERT(INT, @tmpOwningCompanyID) = RP_Flt_1_Foreign_Vehicle_Control_L1_Base.Vehicle_Owning_Company_ID)
	AND	
