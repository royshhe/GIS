USE [GISData]
GO
/****** Object:  View [dbo].[RP_Res_10_Build_Up_On_Rent_CDT_L1_Base]    Script Date: 2021-07-10 1:50:45 PM ******/
SET ANSI_NULLS ON
GO
...
/*
VIEW NAME:  	RP_Res_10_Build_Up_On_Rent_CDT_L1_Base
PURPOSE:   	This view counts number of contract due today for BRAC (local) and foreign locations
...
CREATE VIEW [dbo].[RP_Res_10_Build_Up_On_Rent_CDT_L1_Base]
AS
...
FROM	Contract WITH(NOLOCK)
	...
	JOIN
	Lookup_Table
		ON Lookup_Table.Code = Vehicle.Owning_Company_ID
