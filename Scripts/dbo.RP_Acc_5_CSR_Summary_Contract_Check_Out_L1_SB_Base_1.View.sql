USE [GISData]
GO
/****** Object:  View [dbo].[RP_Acc_5_CSR_Summary_Contract_Check_Out_L1_SB_Base_1]    Script Date: 2021-07-10 1:50:45 PM ******/
SET ANSI_NULLS ON
GO
...
/*
VIEW NAME: RP_Acc_5_CSR_Summary_Contract_Check_Out_L1_SB_Base_1
PURPOSE: Select all the information needed for Contract Check In Subreport 

AUTHOR:	Nenad Ukropina
DATE CREATED: 1999/01/01
USED BY: Contract Check Out Subreport of CSR Summary Activity Report
MOD HISTORY:
Name 		Date		Comments
*/
CREATE VIEW [dbo].[RP_Acc_5_CSR_Summary_Contract_Check_Out_L1_SB_Base_1]
AS
SELECT 	
