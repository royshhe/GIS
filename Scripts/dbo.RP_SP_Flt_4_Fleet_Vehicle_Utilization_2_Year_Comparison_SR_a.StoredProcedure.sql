USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[RP_SP_Flt_4_Fleet_Vehicle_Utilization_2_Year_Comparison_SR_a]    Script Date: 2021-07-10 1:50:50 PM ******/
SET ANSI_NULLS ON
GO
...
/*
PROCEDURE NAME: RP_SP_Flt_4_Fleet_Vehicle_Utilization_2_Year_Comparison_SR_a
...
MOD HISTORY:
Name 		Date		Comments
Joseph Tseung	1999/09/29	add vehicle type filtering
...
*/
CREATE Procedure [dbo].[RP_SP_Flt_4_Fleet_Vehicle_Utilization_2_Year_Comparison_SR_a]
(
	-- target date
	@td_str varchar(20) = '2000/03/05 00:00',
	@paramVehicleTypeID char(5) = '*'
)
AS
DECLARE @td datetime
SELECT @td = DATEADD(DAY, -364, CONVERT(datetime, @td_Str))
-- create IT_OR table
