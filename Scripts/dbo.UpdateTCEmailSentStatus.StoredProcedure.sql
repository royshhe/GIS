USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[UpdateTCEmailSentStatus]    Script Date: 2021-07-10 1:50:51 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE Procedure [dbo].[UpdateTCEmailSentStatus]  --'1609151', 'T1'
...
FROM  (SELECT		VLH.Licence_Plate_Number,
		...
		FROM         dbo.Vehicle_On_Contract VOC INNER JOIN
			...
			Where TC.Email_Sent=0	And RA.Contract_Number=Convert(int,@ContractNumber) and TC.Issuer=@Issuer
