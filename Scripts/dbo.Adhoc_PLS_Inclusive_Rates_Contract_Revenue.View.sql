USE [GISData]
GO
/****** Object:  View [dbo].[Adhoc_PLS_Inclusive_Rates_Contract_Revenue]    Script Date: 2021-07-10 1:50:45 PM ******/
SET ANSI_NULLS ON
GO
...
--
------------------------------------------------------------------------------------------------------------------------
CREATE View [dbo].[Adhoc_PLS_Inclusive_Rates_Contract_Revenue]
as
Select 	
	bt.RBR_Date, 
    	bt.Contract_Number, 
	...
	cci.GST_Amount+cci.GST_Amount_Included as GSTAmt, 
	cci.PST_Amount+cci.PST_Amount_Included  as PSTAmt,  
	cci.PVRT_Amount+cci.PVRT_Amount_Included as PVRTAmt,
...
FROM 	Contract c WITH(NOLOCK)
	...
	Vehicle_Rate vr
        ...
        Left join charge_parameter ccp on ccp.Charge_Type=cci.Charge_Type 
WHERE 	
	...
	and vr.Location_Fee_Included = 1
	and ccp.Location_fee=1
             and cci.Charge_type not in (30,35)
        and veh.owning_company_id = 7425
