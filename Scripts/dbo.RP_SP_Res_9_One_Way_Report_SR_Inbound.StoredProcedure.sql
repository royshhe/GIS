USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[RP_SP_Res_9_One_Way_Report_SR_Inbound]    Script Date: 2021-07-10 1:50:50 PM ******/
SET ANSI_NULLS ON
GO
...
/*
PROCEDURE NAME: RP_SP_Res_9_One_Way_Report_SR_Inbound
PURPOSE: Select all information needed for Inbound Company subreport of Reservation One Way Report

AUTHOR:	Joseph Tseung
DATE CREATED: 1999/09/24
USED BY:   Inbound Company subreport of Reservation One Way Report
MOD HISTORY:
Name 		Date		Comments
*/
CREATE PROCEDURE [dbo].[RP_SP_Res_9_One_Way_Report_SR_Inbound]
(
