USE [GISData]
GO
/****** Object:  View [dbo].[RP_Acc_5_CSR_Summary_Activity_Main_L1]    Script Date: 2021-07-10 1:50:45 PM ******/
SET ANSI_NULLS ON
GO
...
Name 		Date		Comments
*/
CREATE VIEW [dbo].[RP_Acc_5_CSR_Summary_Activity_Main_L1]
AS
SELECT 	
...
UNION 
-- Select Records for Separate Sales Accessory subreport
SELECT 
	Business_Transaction.RBR_Date, 
   	Business_Transaction.Location_ID, 
   	Location.Location AS Location_Name, 
