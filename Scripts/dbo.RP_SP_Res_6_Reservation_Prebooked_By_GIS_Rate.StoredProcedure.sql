USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[RP_SP_Res_6_Reservation_Prebooked_By_GIS_Rate]    Script Date: 2021-07-10 1:50:50 PM ******/
SET ANSI_NULLS ON
GO
...
/*
PROCEDURE NAME: RP_SP_Res_6_Reservation_Prebooked_By_GIS_Rate
PURPOSE: Select all information needed for Reservation Prebooked by GIS Rate by Rate Level Report

AUTHOR:	Joseph Tseung
DATE CREATED: 1999/09/22
USED BY:   Reservation Prebooked by GIS Rate by Rate Level Report
MOD HISTORY:
Name 		Date		Comments
*/
CREATE PROCEDURE [dbo].[RP_SP_Res_6_Reservation_Prebooked_By_GIS_Rate]
(
...
FROM 	RP_Res_6_Reservation_Prebooked_By_GIS_Rate_L1_Base  with(nolock) 
