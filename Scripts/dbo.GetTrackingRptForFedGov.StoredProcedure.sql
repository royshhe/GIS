USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[GetTrackingRptForFedGov]    Script Date: 2021-07-10 1:50:49 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[GetTrackingRptForFedGov] --'2003-12-31', '2004-09-30'
...
or  
Con.Company_Name like '%fed%gov%'
or Con.Company_Name like '%canada%gov%'
or Con.Company_Name like '%gov%fed%'
or Con.Company_Name like '%gov%Canada%'
)
