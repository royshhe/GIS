USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[GetVehClassIDByRate]    Script Date: 2021-07-10 1:50:49 PM ******/
SET ANSI_NULLS OFF
GO
...
PURPOSE: To retrieve all vehicle classes (identified by Rate_Vehicle_Class_Id) 
	 defined for a given rate.
MOD HISTORY:
Name	Date        	Comments
Don K	Feb 29 2000	Added explicit ORDER BY clause
*/
CREATE PROCEDURE [dbo].[GetVehClassIDByRate]
	@RateID varchar(20)
AS
Set Rowcount 2000
Select Distinct
...
--ORDER
--BY	Rate_Vehicle_Class_ID
order by dbo.Vehicle_Class.displayorder
Return 1
GO
