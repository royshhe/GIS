USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[RP_SP_Acc_17_CreateCSRIncentiveRevenue_CP]    Script Date: 2021-07-10 1:50:50 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[RP_SP_Acc_17_CreateCSRIncentiveRevenue_CP] -- '2012-04-01', '2012-04-04'
(
...
delete RP_ACC_17_CSR_Incremental_Incentive_Revenue_CP where (RBR_Date BETWEEN @startBusDate and @endBusDate)


--select * from RP_Acc_17_CSR_Incentive_Report_L2 where rbr_date='2006-05-01'
insert INTO RP_ACC_17_CSR_Incremental_Incentive_Revenue_CP
(RBR_date,
EmployeeID, 
EmployeeStatus, 
Location_ID, 
