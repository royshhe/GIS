USE [GISData]
GO
/****** Object:  View [dbo].[RP_SP_Flt_15_Sunny_Cloudy_vw]    Script Date: 2021-07-10 1:50:45 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE view [dbo].[RP_SP_Flt_15_Sunny_Cloudy_vw]
...
FROM 	RP_SP_Flt_15_Sunny_Cloudy_Local_vw
...
SELECT 	
	...
	sunnycloudycode,
	Rented as FleetNumber
FROM 	RP_SP_Flt_15_Sunny_Cloudy_OneWay_vw
