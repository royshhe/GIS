USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[AM_GetEFTRBRDate]    Script Date: 2021-07-10 1:50:47 PM ******/
SET ANSI_NULLS OFF
GO
...
Create PROCEDURE [dbo].[AM_GetEFTRBRDate]
AS

	SELECT	RBR_Date,Budget_Start_Datetime, Budget_Close_Datetime
	FROM	RBR_Date
	WHERE	( Budget_Close_Datetime IS NOT NULL) and Date_AMEFT_Submitted  is null
