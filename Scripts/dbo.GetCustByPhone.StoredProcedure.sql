USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[GetCustByPhone]    Script Date: 2021-07-10 1:50:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

/****** Object:  Stored Procedure dbo.GetCustByPhone    Script Date: 2/18/99 12:11:53 PM ******/
/****** Object:  Stored Procedure dbo.GetCustByPhone    Script Date: 2/16/99 2:05:41 PM ******/
/****** Object:  Stored Procedure dbo.GetCustByPhone    Script Date: 1/11/99 1:03:15 PM ******/
/****** Object:  Stored Procedure dbo.GetCustByPhone    Script Date: 11/23/98 3:55:33 PM ******/
/*  PURPOSE:		To retrieve the customer information for the given phone number.
     MOD HISTORY:
     Name    Date        Comments
	 Roy He	 2011-03-16 MS SQL 2008
*/
CREATE PROCEDURE [dbo].[GetCustByPhone]
	@Phone VarChar(35)
AS
	/* 981019 - cpy - removed DL Province, Country,
			  added DL Jurisdiction */
	/* get active customers by Phone # */
