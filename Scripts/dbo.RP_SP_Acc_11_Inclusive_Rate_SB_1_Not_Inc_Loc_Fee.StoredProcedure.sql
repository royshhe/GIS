USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[RP_SP_Acc_11_Inclusive_Rate_SB_1_Not_Inc_Loc_Fee]    Script Date: 2021-07-10 1:50:50 PM ******/
SET ANSI_NULLS ON
GO
...
/*
PROCEDURE NAME: RP_SP_Acc_11_Inclusive_Rate_SB_1_Not_Inc_Loc_Fee
PURPOSE: Select information of each G/L account for
	 Total Inclusive Revenue by Account (NOT including Location fee) subreport of
	 Inclusive Rate Revenue Split Report

AUTHOR:	Nenad Ukropina
DATE CREATED: 1999/01/01
USED BY: Subreport (not including location fee) of Inclusive Rate Revenue Split Report
MOD HISTORY:
Name 		Date		Comments
Joseph Tseung	2000/02/23	Do not select the inclusive time interval here
*/
CREATE Procedure [dbo].[RP_SP_Acc_11_Inclusive_Rate_SB_1_Not_Inc_Loc_Fee]
(
...
SELECT 	1 AS GROUP_ID,
	SUBSTRING(RP_Acc_11_Inclusive_Rate_L3_OE_SA_FPO.GL_Revenue_Account, 1,5) + '-'
	    ...
	    SUM(RP_Acc_11_Inclusive_Rate_L1_Time_Revenue.Inclusive_Time_Ravenue) AS Time_Revenue,
...
WHERE   RP_Acc_11_Inclusive_Rate_L1_Contract_Info.Location_Fee_Included = 'N'
        AND
