USE [GISData]
GO
/****** Object:  View [dbo].[RP_Res_10_Build_Up_On_Rent_COR1_L1_Base]    Script Date: 2021-07-10 1:50:45 PM ******/
SET ANSI_NULLS ON
GO
...
/*
VIEW NAME:  	RP_Res_10_Build_Up_On_Rent_COR1_L1_Base
...
MOD HISTORY:
Name 		Date		Comments
Joseph Tseung	1999/11/18	Base the count on Pick Up Location instead of Drop off Location.
...
CREATE VIEW [dbo].[RP_Res_10_Build_Up_On_Rent_COR1_L1_Base]
AS
SELECT 	
