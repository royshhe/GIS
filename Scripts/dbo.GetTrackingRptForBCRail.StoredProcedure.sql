USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[GetTrackingRptForBCRail]    Script Date: 2021-07-10 1:50:49 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[GetTrackingRptForBCRail]
...
insert into #tmp_contract
	...
	and con.company_name like 'BC%Rail%'
	and con.status = 'CI'
