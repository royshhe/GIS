USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[RP_SP_Acc_12_CreateCSRIncentiveRevenue]    Script Date: 2021-07-10 1:50:50 PM ******/
SET ANSI_NULLS OFF
GO
...
CREATE PROCEDURE [dbo].[RP_SP_Acc_12_CreateCSRIncentiveRevenue]
(
...
SELECT 	csr.EmployeeID,
  ...
  --	(sum( case when r1.Contract_Revenue > r1.Reservation_Revenue and r1.Walk_up = 0
	...
	--) --*0.5	
       ...
       /* sum( case when  (r1.Contract_TnKm_Revenue)>  (r1.Reservation_Revenue) and  r1.Walk_up = 0 and  r1.upgrade=0
		 then  (r1.Contract_TnKm_Revenue)-  (r1.Reservation_Revenue)
		else 0 
		end)	
	
	+ sum( r1.upgrade)	                       as Up_sell,

	sum(case when (r1.Rental_Time_Revenue > r2.BaseAmount) and (r2.BaseAmount>0)
	...
	0 	as FPO_PO,
	0	as Up_sell_PO,
	0	as Additional_Driver_Charge_PO,
	0	as All_Seats_PO,
	0 	as Driver_Under_Age_PO,
	0	as All_Level_LDW_PO,
	0 	as PAI_PO,
	0 	as PEC_PO,
	0	as Ski_Rack_PO,
	0	as All_Dolly_PO,
	...
	(sum( case when  (Contract_TnKm_Revenue)>  (r1.Reservation_Revenue) and  r1.Walk_up = 0 and  r1.upgrade=0
		 then  (Contract_TnKm_Revenue)- (r1.Reservation_Revenue)
		else 0 
		end)	
		+ sum(case when  r1.upgrade > 0
			then r1.upgrade
			else 0
			end)
