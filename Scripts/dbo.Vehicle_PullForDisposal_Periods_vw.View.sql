USE [GISData]
GO
/****** Object:  View [dbo].[Vehicle_PullForDisposal_Periods_vw]    Script Date: 2021-07-10 1:50:45 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[Vehicle_PullForDisposal_Periods_vw]
AS
...
WHERE     (CatVehicleStatus.Value = 'Pulled For Disposal')
