USE [GISData]
GO
/****** Object:  StoredProcedure [dbo].[RP_SP_Res_8_Reservation_Breakdown_By_GIS_Rate_Name]    Script Date: 2021-07-10 1:50:50 PM ******/
SET ANSI_NULLS ON
GO
...
/*
PROCEDURE NAME: RP_SP_Res_8_Reservation_Breakdown_By_GIS_Rate_Name
PURPOSE: Select all information needed for Reservation Breakdown by GIS Rate Name Reports (One or All rate names)

AUTHOR:	Joseph Tseung
DATE CREATED: 1999/09/23
USED BY:   Reservation Breakdown by GIS Rate Name Reports (One or All rate names)
MOD HISTORY:
Name 		Date		Comments
*/

CREATE PROCEDURE [dbo].[RP_SP_Res_8_Reservation_Breakdown_By_GIS_Rate_Name]
(
...
FROM	RP_Res_8_Reservation_Breakdown_By_GIS_Rate_Name_L1_Base  with(nolock) 
